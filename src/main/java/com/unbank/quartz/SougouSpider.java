...
public class SougouSpider {
	...
	private static Log logger = LogFactory.getLog(SougouSpider.class);
	...
	public void spider() {
		...
		for (String url : openids) {
			...
			try {
				// http://weixin.sogou.com/gzh?openid=oIWsFtywwCsYrqK8-7vQQ_tfLphc&amp;ext=S9aWznSVzeERT9yG3R7fSYJikLx62QX_f5O4Cyc4r8T-CrKl8khk6NggwGM-Pvy0
				// http://weixin.sogou.com/gzh?openid=oIWsFt5eIJfwoVa2uRY4ck85fVvc&amp;ext=S9aWznSVzeE99LFhdD12Df1CCO1PZ1-qHfO5rMTayhZuPEQsq3WA3NggwGM-Pvy0
